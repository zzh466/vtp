...
trader_1.on("connect", function (result) {
    ...
    trader_1.reqAuthenticate(m_BrokerId, user_info_arr[now_user][3], m_AuthCode, m_AppId, function (result) {
...
trader_1.on("rspAuthenticate", function (result) {
    ...
    trader_1.reqUserLogin(m_BrokerId, user_info_arr[now_user][3], user_info_arr[now_user][2], function (result) {
...
trader_1.on("rspUserLogin", function (requestId, isLast, field, info) {
    ...
    trader_1.reqQryTradingAccount(m_BrokerId, user_info_arr[now_user][1], function (field) {
