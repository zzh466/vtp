...
Persistent<Function> UVPet::constructor;
int UVPet::s_uuid;
std::map<std::string, int> UVPet::event_map;
std::map<int, Persistent<Function>> UVPet::callback_map;
std::map<int, Persistent<Function>> UVPet::fun_rtncb_map;
