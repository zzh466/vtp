...
export function getHoldCondition(data={}){
    const {todayAsk=0, todayBuy=0, yesterdayAsk=0, yesterdayBuy=0, todayVolume=0, todayCancel=0} = data;
...
// export const baseURL = process.env.NODE_ENV === 'development'?'139.196.41.155:8099/vtpmanagerapi': '139.196.41.155:8080/vtpmanagerapi'
